...
const View = () => {
	return (
		<div className={'page page--home'}>
			...
			<Title>Курсавая работа - <Text code>Мессенджер</Text></Title>
			<Title level={2}>Разработал: <Text bold style={{ fontWeight: 800 }}>Товсточуб Владислав</Text> - 481 группа</Title>
